...
if (__name__ == '__main__'):
    ...
    fout = h5py.File('parametric.h5', 'w')
    ...
    for lambda_wavelet in lambda_wavelets:
        for wavelet in wavelets:
            ...
            weak = rec_H[:, :, 420:780, 550:910]
            noise = rec_H[:, :, 50:300, 300:550]

            fout.create_dataset(f'weak_{wavelet}_{lambda_wavelet}', data=weak[3, 0, :, :])
            fout.create_dataset(f'noise_{wavelet}_{lambda_wavelet}', data=noise[3, 0, :, :])
